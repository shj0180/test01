...
def test():
    ...
    automation.WindowControl(class_name='Qt5QWindowIcon',RegexName='userLoginView').Refind(20, 1)
    window = automation.WindowControl(searchDepth=1, ClassName='Qt5QWindowIcon', RegexName=u'userLoginView')
    # 用户名
...
if __name__ == "__main__":
    path = r'D:\sh1-OrientRui_20200703_V2.8.8\OrientRui.exe'
    test()
